(function (root, factory) {
  ...
  DEFAULTS.MARGIN_OUT_SCREEN = 10 * DEFAULTS.DEFAULT_ITEM_HEIGHT;
   ...
   var InfiniteListComponent = React.createClass({displayName: 'InfiniteListComponent',
     ...
     render : function () {
       ...
       if (!this.state.viewPortHeight) { return (React.createElement("div", null)) }
       ...
       var infiniteChildren = _.map(this.props.children, function (ReactCpnt, idx) {
         ...
         return (
          React.createElement(InfiniteListItem, {rendered: isDisplayed, key: idx, ref: refName},
            ReactCpnt
          )
         );
       });
       ...
       return (
         React.createElement("div", {style: wrapperStyle},
          React.createElement("div", {style: listSizerStyle},
            React.createElement("div", {className: "hidden-infinite-list-buffer", refs: "hidden-buffer"}),
            React.createElement("div", {style: positionningDivStyle, ref: "list-rendered"},
              infiniteChildren
            )
          )
        ));
...
//# sourceMappingURL=react-infinite-list.js.map
